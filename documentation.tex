...
\usetheme[engine=lualatex, mathshape=rm, fontdir=auto]{kthpq}
...
\item \texttt{mathshape=rm}, \texttt{sf}, or \texttt{custom}. This determines the shape used for math. The default is \texttt{rm}, serif. \texttt{sf} corresponds to sans-serif and \texttt{custom} means that no new math font is loaded (in case you want to load your own font).
